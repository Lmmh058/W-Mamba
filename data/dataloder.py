...
class Dataset(data.Dataset): 
    ...
    def __getitem__(self, index):
        ...
        img_A,_ = util.imread_uint(A_path, self.irchannels)
        img_B,img_B_uv = util.imread_uint(B_path, self.vichannels)
        ...
        return {'A': img_A, 'B': img_B, 'img_B_uv':img_B_uv, 'A_path': A_path, 'B_path': B_path}
